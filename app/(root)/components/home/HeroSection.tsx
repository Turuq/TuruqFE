  ...
  return (
    <AnimatedSection id="home">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center justify-center">
        <div className="flex flex-col pl-5 lg:pl-10 gap-10">
          {/* Tagline */}
          <div className="flex flex-col gap-0">
            <h1
              className={`uppercase text-white font-thin italic text-5xl lg:text-7xl ml-3`}
            >
              Handling
            </h1>
            <h1
              className={`uppercase text-white font-bold italic text-5xl lg:text-7xl`}
            >
              Made Easy.
            </h1>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <p className="text-pretty text-white text-sm">
              {
        ...
        {/* Hero Image */}
        <div className="hidden lg:flex justify-end items-center w-full rounded-lg relative pr-10">
          <img
