...
export function AdminShopifyOrderTable({
  columns,
  data,
  orders,
  changeMarkedOrders,
  ...
  const [selectedOrder, setSelectedOrder] = useState<ShopifyOrderType>();
      ...
      <Table className="overflow-x-scroll bg-white rounded-t-xl">
        <TableCaption className="capitalize">
          <div className="flex items-center justify-between gap-5">
            ...
            <span className="text-center">Shopify Orders List</span>
                    ...
                    {/* <Dialog>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <EditShopifyOrderDialog order={selectedOrder} />
                        </DialogHeader>
                      </DialogContent>
                    </Dialog> */}
                  </div>
