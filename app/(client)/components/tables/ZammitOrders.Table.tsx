...
import { ZammitOrderType } from "@/types/response";
import {
  Table,
  TableBody,
  TableCaption,
...
export default function ZammitOrdersTable({
  orders,
}: {
  orders: ZammitOrderType[];
}) {
  const [data, setData] = useState<ZammitOrderType[]>(orders);
  const [open, setOpen] = useState<boolean>(false);
  const [selectedOrder, setSelectedOrder] = useState<ZammitOrderType | null>(
    null
  );
      ...
      <Table className="overflow-x-scroll bg-white rounded-t-xl">
        <TableCaption className="capitalize">
          <div className="flex items-center justify-between gap-5">
            ...
            <span className="text-center">your zammit orders list</span>
        ...
        <TableHeader className="rounded-xl w-full">
          <TableRow className="rounded-xl">
            ...
            <TableHead className="text-xs font-bold uppercase w-auto">
              company name
            </TableHead>
            <TableHead className="text-xs font-bold uppercase w-auto ">
            ...
            <TableHead className="text-xs font-bold uppercase w-auto text-right rounded-tr-xl">
              Amount
            </TableHead>
          </TableRow>
        </TableHeader>
